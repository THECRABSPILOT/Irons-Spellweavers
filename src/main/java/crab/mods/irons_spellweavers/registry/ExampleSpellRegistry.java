...
import crab.mods.irons_spellweavers.spells.SuperHealSpell;
...
public class ExampleSpellRegistry {
    public static final DeferredRegister<AbstractSpell> SPELLS = DeferredRegister.create(SpellRegistry.SPELL_REGISTRY_KEY, IronsSpellweavers.MODID);
